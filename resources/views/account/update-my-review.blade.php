...
<div class="col-12">
<div class="card">
<h4>{{ __('Update Review - ') }} {{ $r->site->business_name }}</h4>
...
<input class="form-control" type="text" name="review_title" value="{{ $r->review_title }}" >
</div>
<div class="form-group">
<label>{{ __( 'Description' ) }}</label>
<textarea class="form-control" style="height: 180px;" name="review_content">{{ $r->review_content }}</textarea>
</div>
<button type="submit" name="sbReview" class="btn btn-primary btn-block">{{ __('Post Review') }}</button>
<a href="/my-account"  class="btn btn-danger btn-block">{{ __('Cancel') }}</a>
</form>
