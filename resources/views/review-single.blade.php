        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <!--<img src="/public/Hospital location.jpg" alt="" class="img-responsive" style="max-width: 100%;">-->
                            ...
                            <li class="list-group-item">
                                @if($review->claimedBy)
                                    <a class="list-group-item" href="#0" data-toggle="tooltip"
                                       title="{{ __('This facility was claimed and manages reviews on our site') }}">
                                        <h4><i class="far fa-check-square"></i> {{ __('Verified') }}</h4>
                                        {{ __('Facility Claimed & Verified') }}
                                    </a>
                                @else
        ...
        <br>
                    ...
                    <div class="col-md-10 col-9">
                        ...
                        <p class="text-right">
                            ...
                            @else
                                ...
                                <a href="javascript:void(0);" class="text-danger downvote no-hover" data-review="{{ $r->id }}">
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <h5 class="text-center">{{ __( 'Verified Facility' ) }}</h5>
                </div><!-- /.card -->
                <br>
                @endif
